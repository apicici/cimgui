...
//based on imgui.h file version "1.87 WIP" from Dear ImGui https://github.com/ocornut/imgui
...
CIMGUI_API void ImGuiIO_AddKeyModsEvent(ImGuiIO* self,ImGuiKeyModFlags modifiers)
{
    return self->AddKeyModsEvent(modifiers);
}
